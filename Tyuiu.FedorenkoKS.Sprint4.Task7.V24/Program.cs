...
using Tyuiu.FedorenkoKS.Sprint4.Task7.V24.Lib;

namespace Tyuiu.FedorenkoKS.Sprint4.Task7.V24
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Выполнил: Федорено Кирилл Сергеевич | ИСПб-23-1                         *");
            Console.WriteLine("***************************************************************************");
